...
public:
  enum {
    ...
    GreaterEqual = 56, NotEqual = 57, Is = 58, Count = 59, Average = 60, 
    Max = 61, Min = 62, Sum = 63, Null = 64, Identifier = 65, Integer = 66, 
    Date = 67, String = 68, Float = 69, Whitespace = 70, Annotation = 71
  };
  ...
  class  Alter_add_colContext : public Alter_statementContext {
  public:
    Alter_add_colContext(Alter_statementContext *ctx);
  ...
  class  Alter_drop_colContext : public Alter_statementContext {
  public:
    Alter_drop_colContext(Alter_statementContext *ctx);
